...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 11484fb0-7925-4117-a89c-ca348c295db2
```

> `11484fb0-7925-4117-a89c-ca348c295db2` is the password of the certificate, you can change it to any password you want.
